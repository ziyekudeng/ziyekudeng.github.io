...
参考：[thymeleaf模板对没有结束符的HTML5标签解析出错的解决办法](https://blog.csdn.net/yalishadaa/article/details/60768811)
...
参考：[Spring Cloud实战小贴士：随机端口](https://blog.didispace.com/spring-cloud-tips-2/)
