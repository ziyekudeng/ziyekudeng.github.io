...
<html lang="zh" xmlns:th="http://www.thymeleaf.org">
    ...
    <body>
        ...
        <a href="#" th:href="@{ https://ziyekudeng.github.io/neo/{id}(id=${id}) }">激活账号</a>
    </body>
</html>
```
...
可以参考前期文章：[springboot(八)：RabbitMQ详解](https://ziyekudeng.github.io/springboot/2016/11/30/springboot(%E5%85%AB)-RabbitMQ%E8%AF%A6%E8%A7%A3.html) 来实现。
