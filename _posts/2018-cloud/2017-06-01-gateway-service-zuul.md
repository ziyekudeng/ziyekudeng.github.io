...
![](https://ziyekudeng.github.io/assets/images/2017/springcloud/bff-process.png)
...
#这里的配置表示，访问/it/** 直接重定向到https://ziyekudeng.github.io/**
zuul.routes.baidu.path=/it/**
zuul.routes.baidu.url=https://ziyekudeng.github.io/
```
...
-------------
**作者：子夜枯灯**  
**出处：[https://ziyekudeng.github.io/](https://ziyekudeng.github.io/springcloud/2017/06/01/gateway-service-zuul.html)**      
**版权归作者所有，转载请注明出处** 
